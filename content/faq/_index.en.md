...
It is possible, please check the page about [automations and bots](/automations). For simple cases often the hookshot user `@hookshot:gwdg.de` will be enough, for more general cases also a bot-account may be used.
